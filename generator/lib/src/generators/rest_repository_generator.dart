...
import 'package:generator/src/annotations/rest_repository.dart';
import 'package:generator/src/visitor/model_visitor.dart';
...
class RestRepositoryGenerator extends GeneratorForAnnotation<RestRepository> {
  ...
  String generateForAnnotatedElement(
    ...
    print("class: ${annotation?.peek('path')?.stringValue ?? ''}");
    ...
    for (final field in visitor.fields.keys) {
      ...
      List<ElementAnnotation> fiels = visitor.metaData[field];
      fiels.forEach((ElementAnnotation ele) => print("(${ele.element})"));
    }
